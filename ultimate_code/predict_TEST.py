...
def initializeNetwork():
	...
	initialize_model.load_weights('googlenet_single-output_imagenet_iter-150-6dof_high-precision_5k.h5')
...
if __name__ == '__main__':
	...
	#model = load_model('googlenet_single-output_imagenet_iter-150-6dof_high-precision_5k.h5')
	...
	c = np.concatenate((a[0], b[0]), axis=0)
	print(c)
	prediction = c
	print(prediction[0])
